						...
						<div className="col-lg-6 col-md-12">
							<div className="about-content">
								...
								<ScrollAnimation
									...
									animateOnce={true}
								>
									<h2>Bilgi Teknolojilerinin <b>Geleceği</b></h2>
								</ScrollAnimation>
								...
								<ScrollAnimation
									...
									animateOnce={true}
								>
									<p>SAP danışmalığı alanındaki tutku ve tecrübemizle müşteri ihtiyaçlarının detaylı analizi neticesinde en yüksek proje yatırımı getirisinin sağlanmasını amaçlar.</p>
								</ScrollAnimation>
								...
								>
									<ul>
										<li>SAP Emarsys Customer Engagement</li>
										<li>SAP Marketing On-premise & Cloud</li>
										<li>SAP Cloud for Sales and Service</li>
